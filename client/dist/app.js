(function () {
  ...
  */
  ...
  var CharacterTitle = (_dec = customElement('character-title'), _dec2 = property({
    type: String
  }), _dec3 = property({
    type: String
  }), _dec4 = property({
    type: String
  }), _dec(_class = (_class2 = (_temp = class CharacterTitle extends LitElement {
    constructor() {
      super(...arguments);
      ...
      _initializerDefineProperty(this, "descriptor", _descriptor3, this);
    }
    ...
    render() {
      return html(_templateObject2(), this.class, this.name, this.descriptor);
    }
  ...
  }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "class", [_dec3], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "descriptor", [_dec4], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  var _dec$1, _dec2$1, _dec3$1, _dec4$1, _dec5, _dec6, _class$1, _class2$1, _descriptor$1, _descriptor2$1, _descriptor3$1, _descriptor4, _descriptor5, _temp$1;
  ...
  var CharacterSheet = (_dec$1 = customElement('character-sheet'), _dec2$1 = property({
    type: String
  }), _dec3$1 = property({
    type: Object
  }), _dec4$1 = query('.header .img-wrapper'), _dec5 = query('#character-img'), _dec6 = query('.character-name'), _dec$1(_class$1 = (_class2$1 = (_temp$1 = class CharacterSheet extends LitElement {
    constructor() {
      super(...arguments);

      _initializerDefineProperty(this, "theme", _descriptor$1, this);

      _initializerDefineProperty(this, "data", _descriptor2$1, this);

      _initializerDefineProperty(this, "imgWrapper", _descriptor3$1, this);

      _initializerDefineProperty(this, "characterImg", _descriptor4, this);

      _initializerDefineProperty(this, "characterName", _descriptor5, this);
    }
    ...
    getDescriptor() {
      var d = this.data;
      return "Level ".concat(d.level, " ").concat(d.race, " ").concat(d.class);
    }

    render() {
      return html(_templateObject2$1(), this.data.name, this.data.class, this.getDescriptor());
    }

  }, _temp$1), (_descriptor$1 = _applyDecoratedDescriptor(_class2$1.prototype, "theme", [_dec2$1], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), _descriptor2$1 = _applyDecoratedDescriptor(_class2$1.prototype, "data", [_dec3$1], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), _descriptor3$1 = _applyDecoratedDescriptor(_class2$1.prototype, "imgWrapper", [_dec4$1], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor4 = _applyDecoratedDescriptor(_class2$1.prototype, "characterImg", [_dec5], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor5 = _applyDecoratedDescriptor(_class2$1.prototype, "characterName", [_dec6], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
