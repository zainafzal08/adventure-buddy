...
export const SPELLS = [
  {
    name: 'Water Walk',
    concentration: 'Requires No Concentration',
    page: '@ phb Page 287',
    range: '30 feet',
    components: '(V)(S)(M)',
    ritual: 'Is Not a Ritual',
    duration: '1 hour',
    level: 3,
    ...
    classes: 'Cleric, Sorcerer, Ranger, Druid',
    id: 0,
  },
  {
    name: 'Magic Stone',
    concentration: 'Requires No Concentration',
    page: '@ ee Page 20 and xge Page 160',
    range: 'Touch',
    components: '(V)(S)',
    ritual: 'Is Not a Ritual',
    duration: '1 minute',
  ...
  },
  {
    ...
    concentration: 'Requires Concentration',
    page: '@ ee Page 19 and xge Page 159',
    range: 'Self',
    components: '(V)(S)',
    ritual: 'Is a Ritual',
    duration: '10 minutes',
  ...
  },
  {
    name: 'Thunderclap',
    concentration: 'Requires No Concentration',
    page: '@ ee Page 22 and xge Page 168',
    range: '5 feet',
    components: '(S)',
    ritual: 'Is Not a Ritual',
    duration: 'Instantaneous',
    ...
    classes: 'Sorcerer, Warlock, Wizard, Druid, Bard',
    id: 17,
  },
  {
  ...
  },
  {
    ...
    concentration: 'Requires No Concentration',
    page: '@ ee Page 15 and xge Page 150',
    range: '150 feet',
    components: '(V)(S)(M)',
    ritual: 'Is Not a Ritual',
    duration: 'Instantaneous',
  ...
  },
  {
    name: 'Ice Knife',
    concentration: 'Requires No Concentration',
    page: '@ ee Page 19 and xge Page 157',
    range: '60 feet',
    components: '(S)(M)',
    ritual: 'Is Not a Ritual',
    duration: 'Instantaneous',
  ...
  },
  {
    name: 'Skywrite',
    concentration: 'Requires Concentration',
    page: '@ ee Page 22 and xge Page 165',
    range: 'Sight',
    components: '(V)(S)',
    ritual: 'Is a Ritual',
    duration: '1 hour',
  ...
  },
  {
    name: 'Create Bonfire',
    concentration: 'Requires Concentration',
    page: '@ ee Page 16 and xge Page 152',
    range: '60 feet',
    components: '(V)(S)',
    ritual: 'Is a Ritual',
    duration: '1 minute',
  ...
  },
  {
    ...
    classes: 'Cleric, Ranger, Druid, Bard',
    id: 73,
  },
  {
  ...
  },
  {
    name: 'Mold Earth',
    concentration: 'Requires No Concentration',
    page: '@ ee Page 21 and xge Page 162',
    range: '30 feet',
    components: '(S)',
    ritual: 'Is Not a Ritual',
    duration: '1 hour',
  ...
  },
  {
    ...
    school: 'Evocation',
    description:
      'You hurl an undulating, warbling mass of chaotic energy at one creature in range. Make a ranged spell attack against the target. On a hit, the target takes 2d8 damage + 1d6 damage. Choose one of the d8s. The number rolled on that die determines the attack’s damage type, as shown below. d8 Damage Type 1 Acid 2 Cold 3 Fire 4 Force 5 Lightning 6 Poison 7 Psychic 8 Thunder If you roll the same number on both d8s, the chaotic energy leaps from the target to a different creature of your choice within 30 feet of it. Make a new attack roll against the new target, and make a new damage roll, which could cause the chaotic energy to leap again. A creature can be targeted only once by each casting of this spell.',
    classes: 'Sorcerer',
    id: 87,
  },
  {
  ...
  },
  {
    ...
    classes: 'Cleric, Ranger, Paladin, Druid, Bard',
    id: 92,
  },
  {
    name: 'Mind Spike',
  ...
  },
  {
    ...
    classes: 'Cleric, Sorcerer, Wizard, Druid, Bard',
    id: 96,
  },
  {
    name: 'Flame Strike',
  ...
  },
  {
    name: 'Warding Wind',
    concentration: 'Requires Concentration',
    page: '@ ee Page 23 and xge Page 170',
    range: 'Self',
    components: '(V)',
    ritual: 'Is a Ritual',
    duration: '10 minutes',
  ...
  },
  {
    ...
    classes: 'Cleric, Wizard, Druid, Bard',
    id: 124,
  },
  {
    name: 'Wind Walk',
  ...
  },
  {
    ...
    classes: 'Cleric, Ranger, Wizard, Paladin, Druid, Bard',
    id: 128,
  },
  {
    name: 'Enthrall',
  ...
  },
  {
    ...
    school: 'Transmutation',
    description:
      'A nature spirit answers your call and transforms you into a powerful guardian. The transformation lasts until the spell ends. You choose one of the following forms to assume: Primal Beast or Great Tree. Your walking speed increases by 10 feet. You gain darkvision with a range of 120 feet. You make Strength-based attack rolls with advantage. Your melee weapon attacks deal an extra 1d6 force damage on a hit. You gain 10 temporary hit points. You make Constitution saving throws with advantage. You make Dexterity- and Wisdom-based attack rolls with advantage. While you are on the ground, the ground within 15 feet of you is difficult terrain for your enemies.',
    classes: 'Ranger, Druid',
    id: 140,
  },
  {
  ...
  },
  {
    name: 'Earthbind',
    concentration: 'Requires Concentration',
    page: '@ ee Page 17 and xge Page 154',
    range: '300 feet',
    components: '(V)',
    ritual: 'Is a Ritual',
    duration: '1 minute',
  ...
  },
  {
    ...
    classes: 'Cleric, Warlock, Wizard, Druid, Bard',
    id: 153,
  },
  {
    name: 'Forcecage',
  ...
  },
  {
    ...
    classes: 'Cleric, Sorcerer, Druid, Bard',
    id: 161,
  },
  {
  ...
  },
  {
    name: 'Immolation',
    concentration: 'Requires Concentration',
    page: '@ ee Page 19 and xge Page 158',
    range: '90 feet',
    components: '(V)',
    ritual: 'Is a Ritual',
    duration: '1 minute',
  ...
  },
  {
    name: 'Pyrotechnics',
    concentration: 'Requires No Concentration',
    page: '@ ee Page 21 and xge Page 163',
    range: '60 feet',
    components: '(V)(S)',
    ritual: 'Is Not a Ritual',
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    classes: 'Cleric, Sorcerer, Ranger, Paladin, Druid',
    id: 179,
  },
  {
    name: 'Snare',
  ...
  },
  {
    ...
    classes: 'Cleric, Sorcerer, Ranger, Wizard, Paladin, Druid, Bard',
    id: 195,
  },
  {
  ...
  },
  {
    ...
    school: 'Conjuration',
    description:
      'You conjure up a sphere of water with a 5-foot radius at a point you can see within range. The sphere can hover but no more than 10 feet off the ground. The sphere remains for the spell’s duration. Any creature in the sphere’s space must make a Strength saving throw. On a successful save, a creature is ejected from that space to the nearest unoccupied space of the creature’s choice outside it. A Huge or larger creature succeeds on the saving throw automatically, and a Large or smaller creature can choose to fail it. On a failed save, a creature is restrained by the sphere and is engulfed by the water. At the end of each of its turns, a restrained target can repeat the saving throw, ending the effect on itself on a success. The sphere can restrain as many as four Medium or smaller creatures or one Large creature. If the sphere restrains a creature that causes it to exceed this capacity, a random creature that was already restrained by the sphere falls out of it and lands prone in a space within 5 feet of it. As an action, you can move the sphere up to 30 feet in a straight line. If it moves over a pit, cliff, or other drop-off, it safely descends until it is hovering 10 feet above the ground. Any creature restrained by the sphere moves with it. You can ram the sphere into creatures, forcing them to make the saving throw. When the spell ends, the sphere falls to the ground and extinguishes all normal flames within 30 feet of it. Any creature restrained by the sphere is knocked prone in the space where it falls. The water then vanishes.',
    classes: 'Sorcerer, Wizard, Druid',
    id: 199,
  },
  {
  ...
  },
  {
    ...
    concentration: 'Requires Concentration',
    page: '@ ee Page 20 and xge Page 161',
    range: '30 feet',
    components: '(V)(S)(M)',
    ritual: 'Is a Ritual',
    duration: '1 minute',
  ...
  },
  {
    name: 'Erupting Earth',
    concentration: 'Requires No Concentration',
    page: '@ ee Page 17 and xge Page 155',
    range: '120 feet',
    components: '(V)(S)(M)',
    ritual: 'Is Not a Ritual',
    duration: 'Instantaneous',
  ...
  },
  {
    name: 'Whirlwind',
    concentration: 'Requires Concentration',
    page: '@ ee Page 24 and xge Page 171',
    range: '300 feet',
    components: '(V)(M)',
    ritual: 'Is a Ritual',
    duration: '1 minute',
  ...
  },
  {
    ...
    classes: 'Cleric, Sorcerer, Ranger, Wizard, Druid',
    id: 240,
  },
  {
    name: 'Mass Polymorph',
    ...
    school: 'Transmutation',
    description:
      'You transform up to ten creatures of your choice that you can see within range. An unwilling target must succeed on a Wisdom saving throw to resist the transformation. An unwilling shapechanger automatically succeeds on the save. Each target assumes a beast form of your choice, and you can choose the same form or a different ones for each target. The new form can be any beast you have seen whose challenge rating is equal to or less than the target’s (or half the target’s level, if the target doesn’t have a challenge rating). The target’s game statistics, including mental ability score, are replaced by the statistics of the chosen beast, but the target retains its hit points, alignment, and personality. Each target gains a number of temporary hit points equal to hit points of its new form. These temporary hit points can’t be replaced by temporary hit points from another source. A target reverts to its normal form when it has no more temporary hit points or it dies. If the spell ends before then, the creature loses all its temporary hit points and reverts to its normal form. The creature is limited in the actions it can perform by the nature of its new form. It can’t speak, cast spells, or do anything else that requires hands or speech. The target’s gear melds into the new form. The target can’t activate, use, wield, or otherwise benefit from any of its equipment.',
    classes: 'Sorcerer, Wizard, Bard',
    id: 241,
  },
  {
  ...
  },
  {
    ...
    classes: 'Cleric, Sorcerer, Warlock, Wizard, Druid, Bard',
    id: 255,
  },
  {
  ...
  },
  {
    name: 'Frostbite',
    concentration: 'Requires No Concentration',
    page: '@ ee Page 18 and xge Page 156',
    range: '60 feet',
    components: '(V)(S)',
    ritual: 'Is Not a Ritual',
    duration: 'Instantaneous',
  ...
  },
  {
    ...
    classes: 'Cleric, Sorcerer, Warlock, Wizard, Paladin, Druid, Bard',
    id: 295,
  },
  {
    name: 'Invisibility',
  ...
  },
  {
    ...
    school: 'Necromancy',
    description:
      'This spell snatches the soul of a humanoid as it dies and traps it inside the tiny cage you use for the material component. A stolen soul remains inside the cage until the spell ends or until you destroy the cage, which ends the spell. While you have a soul inside the cage, you can exploit it in any of the ways described below. You can use a trapped soul up to six times. Once you exploit a soul for the sixth time, it is released, and the spell ends. While a soul is trapped, the dead humanoid it came from can’t be revived. Eyes of the Dead: You can use an action to name a place the humanoid saw in life, which creates an invisible sensor somewhere in that place if it is on the plane of existence you’re currently on. The sensor remains for as long as you concentrate, up to 10 minutes (as if you were concentrating on a spell). You receive visual and auditory information from the sensor as if you were in its space using your senses. A creature that can see the sensor (such as one using see invisibility or truesight) sees a translucent image of the tormented humanoid whose soul you caged.',
    classes: 'Warlock, Wizard',
    id: 351,
  },
  {
  ...
  },
  {
    name: 'Transmute Rock',
    concentration: 'Requires No Concentration',
    page: '@ ee Page 22 and xge Page 169',
    range: '120 feet',
    components: '(V)(S)(M)',
    ritual: 'Is Not a Ritual',
    duration: 'Until dispelled',
  ...
  },
  {
    name: 'Storm Sphere',
    concentration: 'Requires Concentration',
    page: '@ ee Page 22 and xge Page 166',
    range: '150 feet',
    components: '(V)(S)',
    ritual: 'Is a Ritual',
    duration: '1 minute',
  ...
  },
  {
    ...
    school: 'Necromancy',
    description:
      'Threads of dark power leap from your fingers to pierce up to five Small or Medium corpses you can see within range. Each corpse immediately stands up and becomes undead. You decide whether it is a zombie or a skeleton (the statistics for zombies and skeletons are in the Monster Manual), and it gains a bonus to its attack and damage rolls equal to your spellcasting ability modifier. You can use a bonus action to mentally command the creatures you make with this spell, issuing the same command to all of them. To receive the command, a creature must be within 60 feet of you. You decide what action the creatures will take and where they will move during their next turn, or you can issue a general command, such as to guard a chamber or passageway against your foes. If you issue no commands, the creature do nothing except defend themselves against hostile creatures. Once given an order, the creatures continue to follow it until their task is complete. The creatures are under your control until the spell ends, after which they become inanimate once more.',
    classes: 'Warlock, Wizard',
    id: 392,
  },
  {
  ...
  },
  {
    ...
    classes: 'Ranger, Wizard, Druid, Bard',
    id: 433,
  },
  {
    name: 'Rope Trick',
  ...
  },
  {
    ...
    school: 'Transmutation',
    description:
      'You choose nonmagical flame that you can see within range and that fits within a 5-foot cube. You affect it in one of the following ways: You instantaneously expand the flame 5 feet in one direction, provided that wood or other fuel is present in the new location. You instantaneously extinguish the flames within the cube. You double or halve the area of bright light and dim light cast by the flame, change its color, or both. The change lasts for 1 hour. You cause simple shapes—such as the vague form of a creature, an inanimate object, or a location—to appear within the flames and animate as you like. The shapes last for 1 hour. If you cast this spell multiple times, you can have up to three non-instantaneous effects active at a time, and you can dismiss such an effect as an action.',
    classes: 'Sorcerer, Wizard, Druid',
    id: 451,
  },
  {
